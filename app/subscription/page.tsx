...
export default async function SubscriptionPage() {
  ...
  return <main className="subscription-page">
    ...
    <section className="pricing-grid">
      ...
      <div className="pricing-card pricing-card-pro"><span className="plan-label">MOST POPULAR</span><h2>Pro</h2><div className="price">$9.99 <small>/ month</small></div><p className="muted">Full access for serious career preparation.</p><DemoPaymentForm action={completeDemoPayment} /><p className="annual-price">Save with the $99.99 yearly plan.</p><ul><li>Unlimited tests and all courses</li><li>Advanced resume builder and templates</li><li>Priority applications and recruiter visibility</li><li>Complete analytics, priority support and ✓ PRO verified badge</li></ul></div>
    </section>
